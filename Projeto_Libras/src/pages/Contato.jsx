                ...
                <div className="conteudo">
                    ...
                    <div className="coluna-direita">
                        ...
                        <div className="caixa">
                            ...
                            <div className="linha">
                                <img src={IconLibras} className="icone"/>
                                <div>
                                    <p><strong>Atendimento em Libras</strong></p>
                                    <p className="sub">Agende uma videochamada<br/>Segunda a Sexta: 8h às 17h</p>
                                </div>
                            </div>

                            <div className="linha">
                                <img src={IconClock} className="icone"/>
                                <div>
                                    <p><strong>Horário de Atendimento</strong></p>
                                    <p className="sub">Segunda a Sexta: 8h às 18h<br/>Sábado: 9h às 13h</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="caixa">
                            ...
                            <p><strong>• Como criar uma conta?</strong><br/>
                            Acesse o botão “Cadastrar” e preencha os dados solicitados.</p>
